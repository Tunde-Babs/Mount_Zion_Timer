...
Call log:
  - waiting for getByRole('textbox', { name: 'Card number' })
...
- generic [ref=f2e1]:
    ...
    - generic [ref=f2e46]:
      - main [ref=f2e47]:
        ...
        - generic [ref=f2e65]:
          ...
          - button [ref=f2e251] [cursor=pointer]:
            - generic [ref=f2e253]: Pay
            - generic [ref=f2e254]: Processing
        - generic [ref=f2e266]:
          - checkbox [ref=f2e267]
          - text: I am an AI agent acting on behalf of someone else
      - contentinfo [ref=f2e269]:
        - link [ref=f2e271] [cursor=pointer]:
          - /url: https://stripe.com
          - generic [ref=f2e272]: Powered by
        - link [ref=f2e277] [cursor=pointer]:
  ...
  - dialog [ref=f2e280]:
    - generic [ref=f2e282]:
      - generic [ref=f2e283]:
        - link "Link" [ref=f2e284] [cursor=pointer]:
          - /url: https://link.com/
        - button "close" [ref=f2e293] [cursor=pointer]
      - generic [ref=f2e299]:
        - text: Confirm it’s you
        - generic [ref=f2e300]:
          - generic [ref=f2e301]:
            - text: Enter the code sent to
            - generic [ref=f2e302]: (•••) ••• ••23
            - text: to use your saved information.
          - generic [ref=f2e304]: You are currently testing and no code will be sent. Enter 000000 to continue.
        - generic [ref=f2e307]:
          - textbox "Security code character 1" [active] [ref=f2e308]
          - textbox "Security code character 2" [ref=f2e309]
          - textbox "Security code character 3" [ref=f2e310]
          - textbox "Security code character 4" [ref=f2e311]
          - textbox "Security code character 5" [ref=f2e312]
          - textbox "Security code character 6" [ref=f2e313]
        - button "Send code to email instead" [ref=f2e318] [cursor=pointer]
        - separator [ref=f2e323]
        - generic [ref=f2e324]: Logging in as tunaj2005@yahoo.com. Your device will be remembered for next time.
```
